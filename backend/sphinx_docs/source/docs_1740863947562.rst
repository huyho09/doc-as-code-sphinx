Below is Sphinx-compatible reStructuredText (RST) documentation for the given source code. This documentation follows the structure and details provided in your code comments and description.
